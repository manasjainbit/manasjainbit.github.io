    ...
    <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="http://localhost:8080/CBSMS/Login.php">Login</a>
                </div>
                        ...
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <form action="validate/validateLogin.php" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-info btn-fill">Login</button>
